  ...
  render() {
    ...
    return (
      <MDBCard className="my-5">
        <MDBCardBody>
          <MDBCardTitle>Переведите деньги на временный счет для начала работы</MDBCardTitle>
          <MDBCardText>
            Деньги будут переведены наставнику оператором сервиса после того, как вы подтвердите выполнение работы. 
          </MDBCardText>
          {this.state.apiKey && (
