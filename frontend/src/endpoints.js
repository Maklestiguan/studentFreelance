...
export const cityListUrl = endpoint + 'accounts/cities/';

export const ageListUrl = endpoint + 'accounts/ages/';

export const gendersListUrl = endpoint + 'accounts/genders/';

export const univercityListUrl = endpoint + 'accounts/univercities/';
